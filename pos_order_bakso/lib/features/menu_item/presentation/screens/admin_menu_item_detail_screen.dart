...
@RoutePage()
class AdminMenuItemDetailScreen extends ConsumerStatefulWidget {
  final MenuItemModel menuItem;

  const AdminMenuItemDetailScreen({super.key, required this.menuItem});

  @override
  ConsumerState<AdminMenuItemDetailScreen> createState() =>
      _AdminMenuItemDetailScreenState();
}

class _AdminMenuItemDetailScreenState
    extends ConsumerState<AdminMenuItemDetailScreen> {
    ...
    final bool? confirmed = await showDialog<bool>(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content: Text(
            'Apakah Anda yakin ingin menghapus menu "${widget.menuItem.name}"?\nTindakan ini tidak dapat diurungkan.',
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Harga: Rp ${widget.menuItem.price.toStringAsFixed(0)}',
            ...
            children: <Widget>[
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (String choice) {
                  if (choice == 'edit') {
                    context.pushRoute(
                      AdminMenuItemUpsertRoute(menuItem: widget.menuItem),
                    );
