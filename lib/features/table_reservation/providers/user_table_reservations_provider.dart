...
import 'package:jamal/features/table_reservation/providers/user_table_reservations_state.dart';

class UserTableReservationsNotifier
    extends StateNotifier<UserTableReservationsState> {
  final TableReservationRepo _tableReservationRepo;
  static const int _defaultLimit = 10;

  UserTableReservationsNotifier(this._tableReservationRepo)
    : super(UserTableReservationsState()) {
